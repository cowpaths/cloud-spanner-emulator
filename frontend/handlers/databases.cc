...
absl::Status ListDatabases(RequestContext* ctx,
  ...
  if (!request->page_token().empty()) {
    ...
    GOOGLESQL_RETURN_IF_ERROR(ParseDatabaseUri(request->page_token(), &project_id,
...
absl::Status UpdateDatabaseDdl(
  ...
  GOOGLESQL_RETURN_IF_ERROR(backend_database->UpdateSchema(
...
absl::Status GetDatabaseDdl(RequestContext* ctx,
  ...
  GOOGLESQL_ASSIGN_OR_RETURN(std::string proto_descriptor_bytes,
